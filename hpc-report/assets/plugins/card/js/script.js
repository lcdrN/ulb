var materialCards = (function () {
    ...
    return {
        ...
        initialize: function (
            parentID, ajaxID, noDataFoundMessage, udConfigJSON, items2Submit, bindRefreshOnId, escapeRequired, json, width) {
            var stdConfigJSON = {
                "cardWidth": width,
                "refresh": 0
            };
                ...
                if (cardData && cardData.length > 0) {
                    $.each(cardData, function (index, objData) {
                        if (escapeRequired !== false) {
                            ...
                            objData.CARD_INFOS = util.escapeHTML(objData.CARD_INFOS);
                        }
            ...
            function drawSmallCard(index, parent, cardData, cardConfig) {
                ...
                */
                ...
                cardBody.append('<h2 class="title" style="color:'+color+'">' + value + '</h2>');
            ...
            function drawLargeCard(index, parent, cardData, cardConfig, chartConfig) {
                ...
                */
                ...
                cardBody.append("<h2 class=\"title\" title="+cardData.CARD_INFOS+">" + value + "</h2>");
                ...
                if (cardData.CARD_CHART_DATA) {
                    ...
                    chartIst.on('draw', function (context) {
                        ...
                        if(standardChartConfig.sliceWidth) $(chart).find(".ct-slice-donut").css("stroke-width", standardChartConfig.sliceWidth.toString() + "px");
                        ...
                        $(chart).find(".ct-slice-donut").css("stroke-dasharray", 1000);
                        $(chart).find(".ct-slice-donut").css("stroke-dashoffset", 1000);
                        $(chart).find(".ct-slice-donut").css("animation", "dash 5s linear forwards");
